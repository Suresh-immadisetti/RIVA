            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-4">
                ...
                <div className="flex flex-col">
                  <a href="tel:+916300021355" className="text-slate-300 hover:text-white transition block">+91 6300021355</a>
                  <a href="tel:+919000770825" className="text-slate-300 hover:text-white transition block">+91 9000770825</a>
                  <a href="tel:+919032412905" className="text-slate-300 hover:text-white transition block">+91 9032412905</a>
                </div>
              </li>
